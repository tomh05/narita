...
class ScreensControllerTest < ActionController::TestCase
  ...
  test "should create screen" do
    assert_difference('Screen.count') do
      post :create, screen: { event_time: @screen.event_time, event_type: @screen.event_type, username: @screen.username }
    end
  ...
  test "should update screen" do
    patch :update, id: @screen, screen: { event_time: @screen.event_time, event_type: @screen.event_type, username: @screen.username }
    assert_redirected_to screen_path(assigns(:screen))
  end
