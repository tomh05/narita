class ContactsController < ApplicationController
  ...
  def import
    ...
    csv.each do |row|
      ...
      @contact = Contact.find_or_initialize_by(contact_name: row[2].to_s, contact_number: row[3])
  ...
  private
    ...
    def contact_params
      params.require(:contact).permit(:event_time, :contact_name, :contact_number)
    end
end
